...
config :phoenix_example_multi_nested_form, PhoenixExampleMultiNestedFormWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r{priv/gettext/.*(po)$},
      ~r{lib/phoenix_example_multi_nested_form_web/views/.*(ex)$},
      ~r{lib/phoenix_example_multi_nested_form_web/templates/.*(eex)$},
...
config :phoenix_example_multi_nested_form, PhoenixExampleMultiNestedForm.Repo,
  username: "postgres",
  password: "postgres",
  database: "phoenix_example_multi_nested_form_dev",
  hostname: "localhost",
  pool_size: 10
