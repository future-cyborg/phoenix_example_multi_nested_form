defmodule PhoenixExampleMultiNestedFormWeb.CommentControllerTest do
  use PhoenixExampleMultiNestedFormWeb.ConnCase
  ...
  def fixture(:comment) do
    {:ok, comment} = Example.create_comment(@create_attrs)
    comment
  end
